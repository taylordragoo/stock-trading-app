...
<template>
    ...
    <AuthenticatedLayout>
                    ...
                    <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                        <thead class="align-bottom">
                            <tr>
                                ...
                                <th class="px-6 py-3 font-bold uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap">Shares Owned</th>
                                <th class="px-6 py-3 font-bold uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap">Buy Price</th>
                                ...
                                <th class="px-6 py-3 font-bold uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap">Profit/Loss</th>
                        ...
                        <tbody>
                            <tr v-if="!loading" v-for="t in mappedStockData">
                                ...
                                <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <span class="font-semibold leading-tight text-xs text-gray-800">{{ formatCurrency(t.original_price) }}</span>
                                </td>
                                <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                ...
                                <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <span class="font-semibold leading-tight text-xs text-gray-800">{{ formatCurrency(t.total) }}</span>
                                </td>
                                <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <span class="font-semibold leading-tight text-xs text-gray-800">{{ formatCurrency(t.total - (t.original_price * t.quantity)) }}</span>
                                </td>
        ...
        <Company v-if="active !== null" :wallet="this.$page.props.userWallet" :ticker="active" @reload-snapshots="getBulkSnapshots" @close="active = null" />
    </AuthenticatedLayout>
</template>
